...
class Baseball:
    ...
    stadium_dic = {'LG':'잠실','롯데':'사직','KIA':'광주','삼성':'대구','두산':'잠실','한화':'대전','SK':'문학','키움':'고척','넥센':'고척','NC':'마산','KT':'수원','kt':'수원'}
    
    # 분석에 사용한 year_list
    year_list = [2017,2018,2019,2020]
    
    # 구장별 Park Factor dictionary
...
class Precleaning(Baseball):
    ...
    Class Precleaning
        ...
        크롤링을 통해 가져온 raw-data를 분석에 용이한 형태로 전처리
    ...
    def save_array_to_csv(self):
        '''
        Save batter_array / pitcher_array / score_array 
